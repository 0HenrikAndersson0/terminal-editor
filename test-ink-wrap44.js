...
const App = () => {
    return (React.createElement(Box, { width: 30, flexDirection: "row" },
        ...
        React.createElement(Box, { flexGrow: 1, flexShrink: 0, width: 24 },
            React.createElement(Box, { flexDirection: "row", overflowX: "hidden" },
                React.createElement(Text, { wrap: "truncate" }, Array.from({ length: 25 }).map((_, i) => React.createElement(Text, { key: i }, i % 10)))))));
};
